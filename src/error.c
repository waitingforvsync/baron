...
rc_str error_type_name(error_type e)
{
    switch (e) {
        ...
        case error_type_reserve_not_zeropage:    return RC_STR("ZA_POOL address outside the zero page");
        ...
        case error_type_za_auto_unused:          return RC_STR("Unused ZA_AUTO variable: '%'");
        case error_type_za_auto_narrow_pointer:  return RC_STR("ZA_AUTO1 dereferenced as a pointer (declare it ZA_AUTO2)");
        case error_type_za_auto_out_of_bounds:   return RC_STR("Access past the end of ZA_AUTO variable");
        case error_type_za_auto_bad_width:       return RC_STR("ZA_AUTO count must be 1 to 256");
        ...
        case error_type_included_from:           return RC_STR("Note: Included from here");
        ...
        case error_type_expanded_from:           return RC_STR("Note: Expanded from here");
